...
export const resolvers = {
    ...
    Mutation: {
        addUser: async (_: any, args: any) => { // this will be used to register a user
        ...
        loginUser: async(_: any, args: any) => {  // this will check if a user has an account and give a user a login token
            const { email, password } = args;
            try {
