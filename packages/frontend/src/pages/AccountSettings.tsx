...
import { Form, Card, Button, Collapse, Modal } from 'react-bootstrap'
import { useMeEmailQuery } from '../generated/types-and-hooks'
import { useChangeEmailMutation , useChangePasswordMutation , useDeleteAccountMutation , useLoginMutation} from '../generated/types-and-hooks'
        ...
        <Layout>
            ...
            <div> 
                            ...
                            <div id="example-collapse-text"> 
                                <form onSubmit = {validateEmail}>
                                    <div className="input-group mb-3">
                                        {emailError && <Alert variant="danger">{emailError.message}</Alert>}
                                        <input
                                            type="email"
                                            ...
                                            value={newEmail}
                                        />
                                        <button className="button btn-outline-secondary" type="submit">
                                            submit
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div>
                                <div id="example-collapse-text"> 
                                    <form onSubmit = {validatePassword}>
                                       {/*Password Fields*/}
                                       {passwordError && <Alert variant="danger">{passwordError.message}</Alert>}
                ...
                <div>
                        ...
                        <Button type="button" className="btn btn-primary" variant="light" onClick={handleShow}>
                            Delete Account
                        </Button>
                            {/*   Modal   */}  
                        <Modal show={show} onHide={handleClose}>
                            ...
                            <Modal.Body>You are about to delete your account. Once deleted, you will be unable to recover your sleep data. </Modal.Body>
                            <Modal.Footer>
                            <Button variant="secondary" onClick={handleClose}>
                                Go Back
                            </Button>
                            <Button variant="primary" type="submit" onSubmit={deleteMyAccount}>
                                {deleteAccountError && <Alert variant="danger">{deleteAccountError.message}</Alert>}
                                I'm Sure!
                            </Button>
                            </Modal.Footer>
                        </Modal>
