      ...
      <div className="container" >
        ...
        <form onSubmit={collectData}>
          ...
          <div className="form-group text-center"> 
            <p><b>What was the date?</b></p>
            <DatePicker selected={date}
            onSelect={date => setLogDate(date)}/>
          </div>
          <div className="form-group text-center"> 
            <p><b>How many hours did you sleep that night?</b></p>
           <ReactBootstrapSlider min="0" max="14"
             value={sleepHours}
             slideStop = {(event) => setSleep(event.target.value)}></ReactBootstrapSlider>
          </div>
          <br></br>
          <div className="form-group text-center"> 
            <p><b>How well did you sleep that night?</b></p>
            <p>0 = terribly. 10 = like a baby.</p>
           <ReactBootstrapSlider min="0" max="10"
             value={feltRested}
             slideStop = {(event) => setFeltRested(event.target.value)}></ReactBootstrapSlider>
          </div>
          <br></br>
          <div className="form-group text-center">
            <p><b>Did you dream?</b></p>
          ...
          <br></br>
          <div className="form-group text-center">
            <p><b>What was your caffeine intake during the day</b></p>
            <p>Units are cups of coffee (1 cup = ~85mg)</p>
           <ReactBootstrapSlider min="0" max="12"
             value={caffeine}
             slideStop = {(event) => setCaffeine(event.target.value)}></ReactBootstrapSlider>
          </div>
          <br></br>
          <div className="form-group text-center">
            <p><b>How much stress did you experience?</b></p>
            <p>0 = too blessed to be stressed. 10 = currently being chased by a bear.</p>
           <ReactBootstrapSlider min="0" max="12"
             value={anxiety}
             slideStop = {(event) => setAnxiety(event.target.value)}></ReactBootstrapSlider>
          </div>
